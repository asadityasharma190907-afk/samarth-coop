import uuid
from sqlalchemy import Column, String, Numeric, Integer, DateTime, ForeignKey, func, text
...
class BookingOffer(Base):
    ...
    status = Column(String(20), nullable=False, default="offered", server_default=text("'offered'"))
